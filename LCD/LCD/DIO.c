...
{
	if((PortNum >= Aport) && (PortNum <= Dport) )
	{
		switch(PortNum)
		{
			case Aport: PORTA = PortValue; break;
			case Bport: PORTB = PortValue; break;
			case Cport: PORTC = PortValue; break;
			case Dport: PORTD = PortValue; break;
			default: break;
		}
	}
	else
